...
public class UserClient {
	...
	public void interactWithUser() {
		...
		while (again) {
			...
			case "read":
				restClient.callServer(service.getCommand(scanner, username, READ_MESSAGE, true), "read");
				break;
			case "post":
				restClient.callServer(service.getCommand(scanner, username, POST_MESSAGE, true), "post");
				break;
			case "follow":
				restClient.callServer(service.getCommand(scanner, username, FOLLOW_MESSAGE, true), "follow");
				break;
			case "wall":
				restClient.callServer(service.getCommand(scanner, username, WALL_MESSAGE, false), "wall");
				break;
			case "quit":
				again = false;
				break;
